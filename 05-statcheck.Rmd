...
knitr::kable(df, caption = 'An overview of the publishers included accompanied by descriptive statistics per publisher regarding the extracted APA results.', booktabs = TRUE) %>%
  kableExtra::kable_styling(latex_options = c('scale_down', 'striped', 'hold_position'), position = 'left')
```
...
```{r data-fig1, echo = FALSE, fig.cap = 'Flowchart of the data collection process, specified per step in the collection process.', fig.align = 'center'}
