...
that are detrimental to the research process [@doi:10.17226/1864;@doi:10.1007/pl00022268].
...
in the field of psychology in recent years [@doi:10.1177/0956797611430953;@doi:10.1080/1047840X.2012.692215;@doi:10.1177/1745691612459058;@doi:10.1126/science.aac4716;@doi:10.1177/0956797611417632].
...
@doi:10.1007/pl00022268, where responsible conduct of research is the ideal
...
reflect on the behavior of a researcher and are included in Table `r tabnr`.
...
specific projects. This template includes folders as specified in Table `r tabnr`, which covers many of the research stages. The template
...
[@ostp2000;@doi:10.1080/08989621.2012.650948]. Fabrication is the making up of datasets
...
as Figure `r fignr`, 32 means and standard deviations are presented.
...
```{r ruys, fig.cap="Reproduction of Table 1 from the retracted Ruys and Stapel (2008) paper. The table shows 32 cells with 'M (SD)', of which 15 are direct duplicates of one of the other cells. The original version with highlighted duplicates can be found at osf.io/89mcn.", out.width="100%", fig.align="center", echo=FALSE}
par(mar = c(0, 0, 0, 0))
...
manipulation [@doi:10.1083/jcb.200406019;@doi:10.1101/049452], a form of data
...
Stapel case [@levelt2012], the Fuji case [@doi:10.1111/j.1365-2044.2012.07128.x], and in the
...
threats resulted in not retracting the work [@doi:10.1371/journal.pone.0085846]. If retractions
