...
statistical significance seeking (i.e., $p$-hacking). Chapter 3
...
In Chapter 5 I examined evidence for false negatives in nonsignificant
...
Chapter 6 describes a dataset that is the result of content mining
...
In Chapter 7, I test the validity of statistical methods to detect
...
Chapter 8 tackles the issue of data extraction. It is common for
...
domains (access, incentives, reproducibility, inclusivity). In Chapter
9 I argue that "after-the-fact" research papers do not help and
...
certify, archive, and incentivize knowledge production. Chapter 10
