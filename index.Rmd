...
df <- df[ ,2:6]
kable(df, booktabs = TRUE, caption = 'Chapters of the dissertation, chronologically order and supplemented with information about its data package (containing all materials), a link to the preregistration, the preprint, and the peer-reviewed article.') %>%
