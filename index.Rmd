...
back to my first epistemological crisis) within my PhD
...
a lot of potential true effects slip under their radar if nonsignificant
...
data set containing over half a million statistical results extracted
...
what the limitations of the data are. This data set was documented and
...
in order to prevent the issues causing my epistemological crises. A
